...
public final class SLF4J {
    ...
    public interface LifecycleListener {
        ...
        default void onMojoExecutionStart(MavenProject project, Lifecycle lifecycle, MojoExecution execution) {}
    }
    ...
    static void notifyMojoExecutionStart(MavenProject project, Lifecycle lifecycle, MojoExecution execution) {
